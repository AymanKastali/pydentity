...
Revision ID: bbfd7c09ee6f
Revises:
Create Date: 2026-03-13 06:46:41.971288
...
def upgrade() -> None:
    ...
    sa.Column('user_domain_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    sa.Column('user_domain_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('device_domain_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
